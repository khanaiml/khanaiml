...
**Methods:** &nbsp; `Random Forest` · `XGBoost` · `SHAP` · `Physicochemical Descriptors` · `Physical Constraints`
...
A focused study in **scientific reproducibility and evaluation fidelity**.
